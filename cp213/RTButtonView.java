...
public class RTButtonView extends JPanel {
	...
	public void propertyChange(final PropertyChangeEvent evt) {
	    RTButtonView.this.base.setText(RTButtonView.DECIMAL_FORMAT.format(RTButtonView.this.model.getBase()));
	    RTButtonView.this.hypo.setText(RTButtonView.DECIMAL_FORMAT.format(RTButtonView.this.model.getHypotenuse()));
	}
    }
	...
	@Override
	public void propertyChange(final PropertyChangeEvent evt) {
	    RTButtonView.this.height.setText(RTButtonView.DECIMAL_FORMAT.format(RTButtonView.this.model.getHeight()));
	    RTButtonView.this.hypo.setText(RTButtonView.DECIMAL_FORMAT.format(RTButtonView.this.model.getHypotenuse()));
	}
    }
	...
	this.base.setText(RTButtonView.DECIMAL_FORMAT.format(this.model.getBase()));
	this.height.setText(RTButtonView.DECIMAL_FORMAT.format(this.model.getHeight()));
	this.hypo.setText(RTButtonView.DECIMAL_FORMAT.format(this.model.getHypotenuse()));
    }
