...
public class RTSliderView extends JPanel {
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    // your code here
	    int value = RTSliderView.this.baseSlider.getValue();
	    RTSliderView.this.model.setBase(value);
	}
    }
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    // your code here
	    int value = RTSliderView.this.heightSlider.getValue();
	    RTSliderView.this.model.setHeight(value);
	}
    }
